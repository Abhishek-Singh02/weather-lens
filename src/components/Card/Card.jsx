...
var weather_description = splitDisplayName[0] + " " + splitDisplayName[length];
if(weather_description.includes("very")){
  ...
  return (
    <div className={styles.card}>
      ...
      <h1>{(prop.temp.day - 273.5).toPrecision(3) + "° C"}</h1>
      <h4> Feels like {(prop.feels_like.day - 273.5).toPrecision(3)}° C</h4>
